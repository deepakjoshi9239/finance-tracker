...
const SavingsGoals = () => {
  ...
  useEffect(() => {
    const fetchGoals = async () => {
      try {
        ...
        const res = await axios.get(`${process.env.REACT_APP_BACKEND_URL}/api/savings-goals`, {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const token = localStorage.getItem('token');
      const res = await axios.post(`${process.env.REACT_APP_BACKEND_URL}/api/savings-goals`, {
        name: goalName,
  ...
  const handleDelete = async (id) => {
    ...
    try {
      const token = localStorage.getItem('token');
      await axios.delete(`${process.env.REACT_APP_BACKEND_URL}/api/savings-goals/${id}`, {
        headers: { Authorization: `Bearer ${token}` }
      });
